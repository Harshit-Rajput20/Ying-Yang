...
export default function Scene({sentence , flavor}: SkyDiveProps) {
   ...
   useGSAP(()=>{
      ...
      return;
        ...
        .to(cloudsRef.current.position, {z:0, duration: 0.3},
          0)
    ...
    return (
     ...
     <group ref={groupRef}>
        ...
        >
         <pointLight intensity={30} color="#9400D3" decay={0.6}/>
        </FloatingCan>
        </group>
    ...
    <group ref={wordsRef}>
      {sentence && <ThreeText sentence={sentence} color='#F97315'/>}
        ...
        <ambientLight intensity={2} color='	#B22222'/>
...
function ThreeText({sentence , color= "white"} : {
 ...
 return words.map((word: string , wordIndex : number)=>(
    ...
    anchorX={"center"}
    anchorY={"middle"}
    characters="ABCDEFGHIJKLMNOPQRSTUVQXYZ!,.?'"
