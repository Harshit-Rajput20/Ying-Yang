...
// import FloatingCan from "@/components/FloatingCan"
// import AppleModel from "@/components/AppleModel"
// import { Environment, OrbitControls } from "@react-three/drei"
// import { useRef } from "react"
// import * as THREE from "three"
// import { useStore } from "@/hooks/useStore"
...
//     gsap.set(appleRef.current.position, { x: 0, y: -2, z: 1 })
...
//         .from(can2GroupRef.current.position, { y: 5, x: 1 }, 0)
//         .from(can2GroupRef.current.rotation, { z: 3 }, 0)
//         .from(appleRef.current.position, { y: -5 }, 0)
//         .from(appleRef.current.rotation, { x: 2 }, 0)
//     }
...
//       .to(can5Ref.current.rotation, { z: 0.2, x: -0.15 }, 0)
//       .to(groupRef.current.position, { x: 1, duration: 3, ease: "sine.inOut" }, 1.3)
//       .to(appleRef.current.rotation, { y: Math.PI * 2 }, 0)
//   })
