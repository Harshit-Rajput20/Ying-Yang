  ...
  return (
    <group ref={groupRef}>
      ...
      <group ref={can2GroupRef}>
        <FloatingCan ref={can2Ref} flavor="strawberryLemonade" floatSpeed={FLOAT_SPEED} />
      </group>
...
//       .to(can1Ref.current.position, { x: -0.3, y: -0.5, z: -0.9 }, 0)
//       .to(can1Ref.current.rotation, { z: 0.25, x: -0.1 }, 0)
//       .to(can2Ref.current.position, { x: 1.1, y: -0.5, z: -1.3 }, 0)
//       .to(can2Ref.current.rotation, { z: -0.15, x: 0.2 }, 0)
//       // .to(can3Ref.current.position, { x: 0.2, y: -0.5, z: -1.3 }, 0)
//       // .to(can3Ref.current.rotation, { z: 0.1, x: -0.05 }, 0)
//       .to(can4Ref.current.position, { x: -0.8, y: -0.5, z: -1.3 }, 0)
//       .to(can4Ref.current.rotation, { z: -0.3, x: 0.1 }, 0)
//       .to(can5Ref.current.position, { x: 0.4, y: -0.5, z: -1.3 }, 0)
//       .to(can5Ref.current.rotation, { z: 0.2, x: -0.15 }, 0)
...
//     <group ref={groupRef}>
//       <group ref={can1GroupRef}>
//         <FloatingCan ref={can1Ref} flavor="strawberryLemonade" floatSpeed={FLOAT_SPEED} />
//       </group>
//       <group ref={can2GroupRef}>
//         <FloatingCan ref={can2Ref} flavor="blackCherry" floatSpeed={FLOAT_SPEED} />
//       </group>

//       {/* <FloatingCan ref={can3Ref} flavor="watermelon" floatSpeed={FLOAT_SPEED} /> */}
//       {/* <FloatingCan ref={can4Ref} flavor="lemonLime" floatSpeed={FLOAT_SPEED} /> */}

//       <FloatingCan ref={can4Ref} flavor="blackCherry" floatSpeed={FLOAT_SPEED} />
//       <FloatingCan ref={can5Ref} flavor="grape" floatSpeed={FLOAT_SPEED} />
